...
;approximate conversion into ergs s-1 cm-2 A-1
   ...
   printf, unit6, '#','Npoints', 'Filter ', 'wl_eff', 'surface', $
    'bandpass1', 'conv_AB', 'Lam/dLam', 'Zero', 'mag_1Jy', 'log(F_nu/nJy)+0.4', $
    format='(a6,2x,a4,a60,2x,a11,2x,a11,2x,a11,2x,a7,a7,1x,a7,1x,a7,1x,a17)'
...
; seb's combined summary file
         printf, unit6,  i, npoint, strcompress('"'+name+'"'), eff_lam, surf, band, convab, eff_lam/band, zero, flux2mag(1., zero), -zero*0.4+9, $
          format='(i6,2x,i4,1x,a,2x,f11.3,2x,f11.3,2x,f11.3,2x,f7.3,f7.2,f7.2,f7.2,f7.2)'
